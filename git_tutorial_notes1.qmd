...
In order to create new branches, go to the 'git' tab on your RStudio console and click 'new branch'.  You can then populate that branch the way you want and ask your associate to work on that branch only (your associate can also create a branch to be reviewed later)
