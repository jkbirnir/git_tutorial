...
>>>>>>> 3c03a1e2b9f620ac2cedcdbe7e6578bcb5e297a8
...
If you click compare and pull requests, github will see if it can merge automatically. If it can, it will. If not, it will create a merge conflict that you must then resolve.
